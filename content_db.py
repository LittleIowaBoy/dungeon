...
ROOM_TEMPLATE_COLUMNS = (
    ...
    "ritual_tether_regen_ms",
    "ritual_tether_regen_hp",
    "resource_race_rival_label",
    "resource_race_reclaim_window_ms",
    "objective_label",
...
DUNGEON_ROOM_TEMPLATE_OVERRIDES = {
    "mud_caverns": (
        _override_template(
            ...
            escort_checkpoints="0,-2",
            escort_harasser_count=1,
            terrain_layout="parallel_lanes",
        ...
        _override_template(
            ...
            escort_checkpoints="0,-2",
            escort_blast_points="0,-3;0,1",
            escort_blast_duration_ms=1600,
            escort_blast_radius=80,
            escort_blast_damage=9,
            escort_carrier_stall_interval_ms=12000,
            escort_carrier_stall_duration_ms=1500,
            terrain_layout="parallel_lanes",
        ...
        _override_template(
            ...
            scripted_wave_sizes="1,2,2",
            terrain_layout="island_cluster_dense",
        ...
        _override_template(
            ...
            puzzle_decay_interval_ms=1800,
            terrain_layout="island_cluster_sparse",
        ...
        _override_template(
            ...
            scripted_wave_sizes="1,2,2",
            terrain_layout="mire_carpet",
            collapse_terrain_effect="quicksand_vents",
            notes="Secure the mire cache, then push out before the marsh closes in.",
        ),
        # ── Boon room biome variants (*_4 slices) ──
        _override_template(
            "rune_altar_chamber",
            display_name="Stone Cipher Altar",
            objective_label="Cipher",
            terrain_layout="alcove_pockets",
            notes="A rune altar carved into quarry stone: choose one cipher-carved rune from three earth-aligned offerings.",
        ),
        _override_template(
            "pact_shrine_chamber",
            display_name="Quarry Pact Shrine",
            objective_label="Pact Stone",
            terrain_layout="island_cluster_sparse",
            notes="A pact stone unearthed from collapsing quarry rock: potent, binding, and remembered by the earth.",
        ),
    ...
    "frozen_depths": (
        ...
        _override_template(
            ...
            objective_damage_cooldown_ms=500,
            escort_checkpoints="2,0",
            escort_blast_points="-3,0;3,0",
            escort_blast_duration_ms=1500,
            escort_blast_radius=72,
            escort_blast_damage=8,
            escort_carrier_stall_interval_ms=10000,
        ...
        _override_template(
            ...
            terrain_layout="fortress_courtyard",
        ...
        _override_template(
            ...
            resource_race_reclaim_window_ms=4500,
            notes="Secure the glacier core before icebound claimants and frost wards seal the chamber. Icebound rivals freeze slowly but hold their grip longer.",
        ),
        _override_template(
            "trap_gauntlet",
        ...
        _override_template(
            ...
            scripted_wave_sizes="1,2,3",
            terrain_layout="fork_split",
            collapse_terrain_effect="slide_activation",
            notes="Claim the reliquary and escape before reinforcements lock the ice lanes.",
        ),
        # ── Boon room biome variants (*_4 slices) ──
        _override_template(
            "rune_altar_chamber",
            display_name="Frost Glyph Altar",
            objective_label="Glyph",
            terrain_layout="column_hall_offset",
            notes="A rune altar etched in crystalline frost: choose one glyph-sealed rune from three cold-preserved offerings.",
        ),
        _override_template(
            "pact_shrine_chamber",
            display_name="Reliquary Pact Shrine",
            objective_label="Pact Seal",
            terrain_layout="fortress_courtyard",
            notes="A frost-sealed pact shrine locked deep in the reliquary: the cold preserves both the power and the cost.",
        ),
        _override_template(
            "ice_thin_ice_field",
            enabled=1,
    ...
    "sunken_ruins": (
        _override_template(
            ...
            objective_damage_cooldown_ms=450,
            escort_checkpoints="0,2",
            escort_harasser_count=2,
            escort_hazard_interval_ms=7000,
            escort_hazard_damage=3,
            terrain_layout="choke_bridge_simple",
        ...
        _override_template(
            ...
            objective_damage_cooldown_ms=500,
            escort_checkpoints="0,2",
            escort_blast_points="0,-2;0,2",
            escort_blast_duration_ms=1500,
            escort_blast_radius=76,
            escort_blast_damage=8,
            escort_carrier_stall_interval_ms=8000,
            escort_carrier_stall_duration_ms=2500,
            terrain_layout="choke_bridge_simple",
        ...
        _override_template(
            ...
            scripted_wave_sizes="1,2,3",
            terrain_layout="choke_bridge_winding",
            resource_race_rival_label="Tide Divers",
            resource_race_reclaim_window_ms=2000,
            notes="Secure the tide pearl before the chamber fills with rival divers and flood pressure. Tide Divers move fast and reclaim in a short surge.",
        ),
        _override_template(
            "trap_gauntlet",
        ...
        _override_template(
            ...
            terrain_layout="river_with_pillars",
        ...
        _override_template(
            ...
            ritual_tether_regen_hp=3,
            terrain_layout="fortress_courtyard",
            notes="Break the tether ward first; it drains life back into the remaining idols every 5 seconds while it stands.",
        ),
        _override_template(
            "timed_extraction",
            ...
            scripted_wave_sizes="1,2,3",
            terrain_layout="choke_bridge_winding",
            collapse_terrain_effect="current_surge",
            notes="Secure the sarcophagus and escape before the chamber floods with enemies.",
        ),
        # ── Boon room biome variants (*_4 slices) ──
        _override_template(
            "rune_altar_chamber",
            display_name="Tidal Seal Altar",
            objective_label="Seal",
            terrain_layout="choke_bridge_simple",
            notes="A rune altar worn by ancient tides: choose one tide-marked rune from three submerged offerings.",
        ),
        _override_template(
            "pact_shrine_chamber",
            display_name="Sunken Pact Shrine",
            objective_label="Pact Relic",
            terrain_layout="alcove_pockets",
            notes="A corroded shrine worn by the tides: still potent, still binding, with no guarantee of what the deep exacts.",
        ),
...
CREATE TABLE IF NOT EXISTS {table_name} (
    ...
    ritual_tether_regen_ms INTEGER NOT NULL DEFAULT 0,
    ritual_tether_regen_hp INTEGER NOT NULL DEFAULT 0,
    resource_race_rival_label TEXT NOT NULL DEFAULT '',
    resource_race_reclaim_window_ms INTEGER NOT NULL DEFAULT 0,
    ...
    puzzle_decay_interval_ms INTEGER NOT NULL DEFAULT 0,
    ...
    collapse_terrain_effect TEXT NOT NULL DEFAULT '',
    escort_checkpoints TEXT NOT NULL DEFAULT '',
    escort_blast_points TEXT NOT NULL DEFAULT '',
    escort_blast_duration_ms INTEGER NOT NULL DEFAULT 0,
    escort_blast_radius INTEGER NOT NULL DEFAULT 0,
    escort_blast_damage INTEGER NOT NULL DEFAULT 0,
    escort_carrier_stall_interval_ms INTEGER NOT NULL DEFAULT 0,
    escort_carrier_stall_duration_ms INTEGER NOT NULL DEFAULT 0,
    escort_harasser_count INTEGER NOT NULL DEFAULT 0,
    escort_stagger_interval_ms INTEGER NOT NULL DEFAULT 0,
    escort_stagger_duration_ms INTEGER NOT NULL DEFAULT 0,
    escort_hazard_interval_ms INTEGER NOT NULL DEFAULT 0,
    escort_hazard_damage INTEGER NOT NULL DEFAULT 0,
