...
class RoomContentBootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap_is_idempotent_and_load_room_catalog_merges_base_with_placeholder(self):
        ...
        self.assertEqual(trap["trap_suppress_duration_ms"], 2000)
        self.assertEqual(trap["trap_suppress_cooldown_ms"], 10000)
        self.assertEqual(trap["trap_safespot_speed_mult"], 0.6)
        self.assertEqual(trap["trap_sweeper_knockback_px"], 64)
        self.assertEqual(trap["trap_intensity_scale"], 1.4)
        ...
        self.assertEqual(frozen_trap["trap_suppress_duration_ms"], 2200)
        self.assertEqual(frozen_trap["trap_suppress_cooldown_ms"], 8000)
        self.assertEqual(frozen_trap["trap_intensity_scale"], 0.8)
        ...
        self.assertEqual(sunken_trap["trap_suppress_duration_ms"], 2500)
        self.assertEqual(sunken_trap["trap_suppress_cooldown_ms"], 7000)
